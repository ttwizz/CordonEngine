...
local module = {
	...
	--// Positioning
		RightArmPos = CFrame.new(-1.27660203, 0.474789619, -1.1472882, 0.99999994, 0, 0, 0, -4.37113883e-08, 1, 0, -1, -4.37113883e-08);
		LeftArmPos = CFrame.new(0.630164385, 0.856690884, -1.97362065, 0.871856868, -0.248931587, 0.421780288, -0.483504236, -0.30026567, 0.822231114, -0.078033179, -0.920800388, -0.382148206);
		GunPos = CFrame.new(0.448157251, -0.702903271, 0.325264245, 0.99999994, 0, 0, 0, -4.37113883e-08, -1, 0, 1, -4.37113883e-08);
	...
	--// Handling
		...
		FireMode = 6; -- 1 = Semi, 2 = Auto, 3 = Burst, 4 = Bolt Action, 5 = Shot, 6 = RPG
	...
	--// Bullet Physics
		BulletPhysics = Vector3.new(0,35,0); -- Drop fixation: Lower number = more drop
		BulletSpeed = 1250; -- Bullet Speed
		BulletSpread = 0; -- How much spread the bullet has
		
		ExploPhysics = Vector3.new(0,20,0); -- Drop for explosive rounds
		ExploSpeed = 800; -- Speed for explosive rounds
	...
	--// Animations
		...
		ReloadAnim = function(char, speed, objs)
			ts:Create(objs[2],TweenInfo.new(0.5),{C1 = CFrame.new(-2.04931116, -1.63385952, -1.21386445, 0.342020065, 4.10752676e-08, -0.939692616, 0.719846129, -0.642787755, 0.262002528, -0.604022861, -0.766044319, -0.219846353)}):Play()
			ts:Create(objs[3],TweenInfo.new(0.5),{C1 = CFrame.new(0.499677539, -1.41326594, -2.24091482, 0.0172014236, -0.384503514, 0.922963202, -0.99680233, 0.0654482692, 0.0458430648, -0.078033179, -0.920800388, -0.382148206)}):Play()
			wait(0.5)		
			...
			wait(0.22)]]--
			ts:Create(objs[3],TweenInfo.new(0.4),{C1 = CFrame.new(1.40928257, 0.135267198, 1.42085838, 0.604557276, 0.643570244, 0.46939075, -0.324762434, -0.338930488, 0.882980943, 0.727351189, -0.686252952, 0.00410459191)}):Play()
			wait(0.33)
			objs[6]:WaitForChild("MagIn"):Play()
			ts:Create(objs[3],TweenInfo.new(0.3),{C1 = CFrame.new(1.3073777, 0.149612665, 0.860357165, 0.604557276, 0.643570244, 0.46939075, -0.501948595, -0.149766535, 0.851831794, 0.61851269, -0.75059104, 0.232496843)}):Play()
			wait(0.26)
			ts:Create(objs[2],TweenInfo.new(0.14),{C1 = CFrame.new(-2.04931116, -1.82109189, -1.21386445, 0.342020065, 4.10752676e-08, -0.939692616, 0.719846129, -0.642787755, 0.262002528, -0.604022861, -0.766044319, -0.219846353)}):Play()
			ts:Create(objs[3],TweenInfo.new(0.14),{C1 = CFrame.new(1.3073777, 0.149612665, 0.720879793, 0.604557276, 0.643570244, 0.46939075, -0.501948595, -0.149766535, 0.851831794, 0.61851269, -0.75059104, 0.232496843)}):Play()
			wait(0.14)
			--MagC:Destroy()
